...
const DESIRABILITY_WEIGHTS = {
  ...
  man: {
    ...
    education: 8,
    height: 7,
    body: 14,       // BMI raw + fitness modifier, scored as one unit
    politics: 8,
    smoking: 5,
    hasKids: 9,
    wantKids: 3,    // compatibility modifier, not standalone
    costOfLiving: 11 // RPP amplifier on income (see COST_OF_LIVING_AMPLIFIER)
  },
