        ...
        <div className={`flex flex-col h-full min-w-[320px] ${isOpen ? 'opacity-100' : 'opacity-0'} transition-opacity duration-200`}>
          ...
          <div className="p-3 flex-shrink-0">
            <div className="relative">
              ...
              <div ref={modeRef} className="absolute bottom-[13px] left-2.5">
                <button
                  type="button"
              ...
              <button
                ...
                className="absolute bottom-[13px] right-2.5 bg-accent text-white w-[26px] h-[26px] rounded-md flex items-center justify-center cursor-pointer"
              >
