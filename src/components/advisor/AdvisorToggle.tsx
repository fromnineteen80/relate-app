      ...
      {isOpen && (
        <div className="flex items-center gap-2 animate-in fade-in slide-in-from-left-2 duration-200">
          <input
            ...
            className="w-56 sm:w-72 border border-stone-200 bg-white rounded-full px-4 py-2.5 text-sm shadow-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent disabled:opacity-50 disabled:bg-stone-50"
          />
          <button
            type="button"
            onClick={onSubmit}
