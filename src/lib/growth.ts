...
// CBT-based exercises, pattern recognition, and self-improvement challenges
...
export const GROWTH_EXERCISES: GrowthExercise[] = [
  // ── COGNITIVE (CBT Core) ──
  {
    ...
    instruction: 'When you notice a strong negative thought about dating or a partner (e.g., "No one will ever want me," "They\'re going to leave"), write it down. Then: (1) Name the distortion (all-or-nothing, catastrophizing, mind-reading, etc.), (2) Write the evidence FOR the thought, (3) Write the evidence AGAINST it, (4) Write a more balanced version.',
    duration: '7 days',
    points: 20,
    framework: 'CBT',
  ...
  },
  {
    ...
    instruction: 'Choose 3 dating experiences you view negatively. For each one: (1) Write the story you tell yourself about it now, (2) Identify what you learned from it, (3) Rewrite the story focusing on what it taught you or how it redirected you. This isn\'t toxic positivity — the experience can still have been painful. The goal is extracting the signal from the noise.',
    duration: '1 session',
    points: 15,
    framework: 'CBT',
    targetArea: 'selfAwareness',
  ...
  },
  {
    ...
    instruction: 'For one week, every time you feel a strong emotional reaction (anger, anxiety, withdrawal, jealousy), immediately note: (1) What happened (the trigger), (2) What you felt in your body, (3) What emotion surfaced, (4) What you did next (your automatic response), (5) What your emotional driver would predict. Look for the pattern by week\'s end.',
    duration: '7 days',
    points: 20,
    framework: 'CBT/IFS',
  ...
  },
  {
    ...
    instruction: 'Your emotional driver is the fear that shows up most in relationships. For one week, notice moments where that fear gets activated — even in small ways. When you catch it: (1) Name it out loud or in writing ("My [driver] is activated"), (2) Ask: "Is this situation actually threatening, or does it just feel like a pattern I know?", (3) Choose one different response than your usual automatic one.',
    duration: '7 days',
    points: 20,
    framework: 'IFS/Attachment Theory',
    targetArea: 'emotionalDrivers',
  },
  ...
  // ── PATTERN RECOGNITION ──
  {
    ...
    instruction: 'For each significant relationship or dating stretch: (1) How did it start? (What attracted you?), (2) When did the first problem appear? (What was it?), (3) How did it end? (Who ended it and why?), (4) What role did you play in the pattern? Look across all of them. What\'s the common thread? The type of person, the stage it breaks down, the reason it ends — one of these will repeat.',
    duration: '1 session',
    points: 25,
  ...
  },
  {
    ...
    instruction: 'Each evening, review your day and note any moment where your attachment style showed up: Did you seek reassurance? Did you pull away when someone got close? Did you test someone? Did you avoid vulnerability? For each instance, write: (1) The situation, (2) Your automatic response, (3) What a securely attached person might have done instead. This isn\'t about shame — it\'s about seeing the pattern clearly.',
    duration: '7 days',
    points: 25,
    framework: 'Attachment Theory',
  ...
  },
  {
    ...
    instruction: 'Recall your last 3 conflicts (with a partner, date, friend, or family member). For each: (1) What was the stated issue? (2) What was the real issue underneath? (3) Which horseman did you ride? (Criticism: "You always..." / Contempt: eye-rolling, sarcasm / Defensiveness: "Yeah but you..." / Stonewalling: shutting down), (4) What was the antidote you could have used instead? Your assessment already identified your highest horseman. See if these conflicts confirm it.',
    duration: '1 session',
    points: 20,
  ...
  // ── BEHAVIORAL / RELATIONAL PRACTICE ──
  {
    ...
    duration: '7 days',
    points: 20,
    framework: 'EFT/Attachment Theory',
    targetArea: 'emotionalCapacity',
  },
  {
    id: 'beh2',
    ...
    instruction: 'Gottman\'s research shows relationships live or die on "bids" — small moments where someone reaches for connection. For one week, actively notice when people make bids toward you (a text, a question, sharing something, a look). Track: (1) The bid, (2) Did you turn toward it (engaged), turn away (ignored), or turn against it (dismissed)? Aim for 80%+ "turn toward" by week\'s end.',
    duration: '7 days',
    points: 15,
    framework: 'Gottman Method',
  ...
  },
  {
    ...
    instruction: 'Look at your Relate Score breakdown. Find the component dragging you down most (fitness, income, education, emotional growth). Pick ONE specific action: (1) Fitness: commit to 4 sessions this week, track them, (2) Income: research one credential or career move, (3) Education: enroll in something, (4) Emotional: start this growth plan. Small consistent actions compound. A 10-point Relate Score improvement can nearly double your match probability.',
    duration: '1 week',
    points: 15,
  ...
  },
  {
    ...
    instruction: 'Think of a small unresolved tension with someone in your life (a friend, sibling, colleague). Initiate a repair: (1) Name what happened without blame, (2) Share how it affected you, (3) Ask what they experienced. Notice your repair speed — how quickly can you move toward resolution? Your assessment shows your repair style. Practice it intentionally so it\'s available when it matters.',
    duration: '1 session',
    points: 15,
    framework: 'Gottman Method/EFT',
    targetArea: 'repair',
  },
  ...
  // ── RELATIONAL / DEEPER WORK ──
  {
    ...
    instruction: 'IFS teaches that we have different "parts" — the protector that keeps people at arm\'s length, the pleaser that abandons your needs, the critic that tells you you\'re not enough. Write down 3-5 parts you notice in yourself. For each: (1) What does this part do? (2) What is it protecting you from? (3) What would happen if you thanked it but didn\'t let it drive? This isn\'t about eliminating parts — it\'s about not letting them run the show.',
    duration: '1 session',
    points: 20,
    framework: 'IFS',
    targetArea: 'selfAwareness',
  },
  {
    ...
    instruction: 'In your last few relationships or dating interactions, when tension arose: Did you move toward (text more, ask questions, seek reassurance, push for resolution) or move away (go silent, get busy, need space, shut down emotionally)? Map 5 specific instances. Then identify: What was the feeling underneath the behavior? Pursuers usually feel fear (of abandonment). Withdrawers usually feel overwhelm (of engulfment). Your emotional driver predicts this — see if it matches.',
    duration: '1 session',
    points: 20,
    framework: 'EFT/Attachment Theory',
    targetArea: 'emotionalDrivers',
  },
  {
    ...
    instruction: 'Wants are preferences (tall, funny, good job). Needs are non-negotiables for your psychological safety (feeling heard, having autonomy, physical affection, reliability). Write your top 5 needs. For each: (1) Have you ever communicated this need directly to a partner? (2) What happens when this need goes unmet? (3) How do you typically try to get it met? (Directly? Indirectly? By testing?) The gap between knowing your needs and expressing them is where most relationship problems live.',
    duration: '1 session',
    points: 15,
    framework: 'EFT/Attachment Theory',
    targetArea: 'wantOffer',
  },
  {
    ...
    instruction: 'Imagine a relationship where you feel completely safe. Not perfect — safe. Write down: (1) How do you communicate when upset? (2) How do you handle disagreements? (3) How do you show love? (4) How do you receive love? (5) What does repair look like after a fight? Now compare this to your last relationship. Where\'s the gap? That gap is your growth edge. Earned security is possible at any age — it starts with knowing what you\'re aiming for.',
    duration: '1 session',
    points: 15,
    framework: 'Attachment Theory',
    targetArea: 'attachment',
...
export function generatePatternInsights(userData: any): string[] {
  ...
  if (attachment?.style && m4?.emotionalDrivers?.primary) {
    ...
    if (style === 'anxious' && driver === 'abandonment') {
      ...
      insights.push('Your anxious attachment combined with an inadequacy driver means you may overperform in relationships — trying to be "enough" — while simultaneously fearing you never will be. The pattern: give too much, burn out, feel unappreciated, withdraw.');
    } else if (style === 'avoidant' && driver === 'injustice') {
      insights.push('Your avoidant style combined with an injustice driver means you may keep score in relationships and use perceived unfairness as a reason to create distance. The pattern: notice imbalance, build resentment silently, withdraw without giving your partner a chance to adjust.');
    } else {
