const CANNED_RESPONSES = [
  "Based on your persona profile, I'd suggest focusing on your conflict repair patterns. Your tendency toward slow repair could be an asset because it means you process deeply, but it may frustrate partners who need quicker resolution.",
  ...
  "Your Gottman scores are in a healthy range. The area to watch is defensiveness, as even moderate scores here can escalate conflicts. Try acknowledging your partner's perspective before explaining yours.",
];
