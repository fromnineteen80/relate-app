...
export default function AstrologyPage() {
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 max-w-3xl mx-auto px-6 py-8 w-full">
          ...
          <span className="subsection-label block">Sun, Moon &amp; Rise</span>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-8 w-full">
        <div className="mb-6">
          <span className="subsection-label">Sun, Moon &amp; Rise</span>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-baseline gap-2 mb-1">
                      <span className="subsection-label">{c.label}</span>
                    ...
                    <span className="card-summary">{c.placement.formatted}</span>
        ...
        {(() => {
          ...
          return (
            <div className="card border border-border mb-6">
              <span className="subsection-label">Your Element Balance</span>
              {balanceSummary && (
                ...
                {(['Fire', 'Earth', 'Air', 'Water'] as const).map(el => {
                  ...
                  return (
                    <div key={el} className={`rounded-lg p-3 ${isActive ? `${colors.bg} border ${colors.border}` : 'bg-background border border-border opacity-50'}`}>
                      ...
                      {isActive && (
                        <p className="card-summary mt-2">{info.description}</p>
                      )}
                    </div>
                  );
                })}
              ...
              {missing.length > 0 && (
                <p className="card-summary mt-3 italic">
