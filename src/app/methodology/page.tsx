      ...
      <section className="px-6 py-16 bg-stone-50 border-b border-border">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-secondary mb-10">
            The assessment takes approximately 100 minutes across four modules. Each module measures a distinct aspect of your relationship profile, and results build progressively as you complete each one.
          </p>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-secondary">134 questions, approximately 38 minutes</p>
              </div>
            </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-secondary">137 questions, approximately 39 minutes</p>
              </div>
            </div>
            <div className="pl-13 space-y-3">
              <p className="text-sm text-secondary leading-relaxed">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-secondary">28 questions, approximately 8 minutes</p>
              </div>
            </div>
            <div className="pl-13 space-y-3">
              <p className="text-sm text-secondary leading-relaxed">
          ...
          <div className="mb-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-secondary">68 questions, approximately 17 minutes</p>
              </div>
            </div>
            <div className="pl-13 space-y-3">
              <p className="text-sm text-secondary leading-relaxed">
