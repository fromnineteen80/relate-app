...
function buildSkillMd(data: {
  ...
  const rawDescription = `Personalized relationship coach built from RELATE Assessment results. Use when user asks about dating, relationships, conflict, self-improvement, or their dating market. Draws from Gottman Method, Attachment Theory, Emotionally Focused Therapy, Internal Family Systems, and Cognitive Behavioral Therapy. Knows their full assessment profile including ${attachment} attachment, ${driver} emotional driver, Relate Score ${score}, and ${matchCount} estimated matches in ${metro}. References their actual data to give specific, evidence-based coaching.`;
...
5. **Ground in evidence.** Your coaching draws from Gottman Method, Emotionally Focused Therapy, Attachment Theory, Internal Family Systems, and Cognitive Behavioral Therapy.
...
### When they need Cognitive Behavioral Therapy coaching
...
5. Use their Growth Plan exercise history if available and build on reflections they've already written
...
*Assessment methodology draws from Gottman Method, Emotionally Focused Therapy, Attachment Theory, Internal Family Systems, and Cognitive Behavioral Therapy. Demographic estimates from U.S. Census Bureau, CDC, Pew Research Center, and Bureau of Justice Statistics.*
`);
...
## Workflow 8: Pattern Recognition & Cognitive Behavioral Therapy Coaching
...
1. **Identify the pattern from data:**
   - Attachment style: **${attachment}**, which predicts their pursue/withdraw tendency
   - Emotional driver: **${driver}**, the fear that hijacks their responses
   - Gottman horseman: their default conflict weapon
   - Want/offer gap: ${gap > 0 ? '+' : ''}${gap}, indicating whether they ask for more than they bring
...
3. **Apply Cognitive Behavioral Therapy techniques:**
...
- A way to apply evidence-based frameworks (Gottman Method, Attachment Theory, Emotionally Focused Therapy, Internal Family Systems, Cognitive Behavioral Therapy) to your daily relationship decisions
...
- **Emotionally Focused Therapy:** Attachment cycles and emotional accessibility in relationships
- **Attachment Theory:** Secure, anxious, avoidant, and disorganized attachment patterns
- **Internal Family Systems:** Parts work, protectors, and exiles
- **Cognitive Behavioral Therapy:** Cognitive distortions in relationship contexts
